...
const projects = [
  ...
  },
  {
    ...
    title: 'VOID CLIMBER',
    year: '2025',
    role: 'Art Direction & Technical Art',
    client: 'FuturePerfect Studios',
    studio: 'INCworks',
    tags: ['Game Development', 'Art Direction', 'Technical Art'],
    description: `Art direction and technical art for FuturePerfect Studios' 2025 video game Void Climber — a roguelike platformer in which the player climbs to the top of a collapsing universe and must survive its hazardous, decaying environment. Work spanned all aspects of the game's visuals: the design of Noise, an interstellar scout with a biomechanical look; level and asset design across four historical "epochs" (prehistory, antiquity, industrial, contemporary); consumable resource and platform-spawner systems; Unreal Engine shader programming and VFX; and a procedural "fractured sky" system that reshuffles the skybox, background, and environment on every playthrough.`,
    mediaDir: 'void-climber',
    cardSub: 'Roguelike platformer — FuturePerfect Studios',
  },
  {
    slug: 'miumiu',
  ...
  },
  {
    ...
    year: '2022',
    role: 'Environment, Character Design & Animation',
    tags: ['Film', 'CG', 'Animation'],
    description: `"Eternal Happiness" is a film made in collaboration with Seoul-based artists Ali Lotz and Saekyul Yoo, with additional 3D clothing design by Sharif Elsabagh. The film premiered as part of a 2022 art exhibition in Glasgow, Scotland.`,
  ...
  },
  {
    ...
    description: `Ongoing environment, character design, and animation work in collaboration with the band CGI Jesus.`,
    mediaDir: 'cgi-jesus',
    cardSub: 'Ongoing collaboration with the band',
  },
  {
    slug: 'pitstop',
    title: 'PITSTOP',
  ...
  },
  {
    ...
    description: `A collection of character designs created for various projects: the Blob Men, gelatinous beings from another realm; Giotto's Devil, inspired by depictions of Satan in frescoes by 14th-century Italian painter Giotto di Bondone; and Maxie, developed for the game 1000 Deaths by Pariah Interactive.`,
    mediaDir: 'character-design',
    cardSub: 'Blob Men, Giotto\'s Devil, Maxie',
  },
  {
    slug: 'ultraman',
